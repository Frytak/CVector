...
const char DATA4[][6] = {"Test1", "Test2", "Test3", "Test4", "Test5", "Test6", "Test7"}; 
const int DATA4_LEN = 7;
const int DATA4_CAP = 8;
const int DATA4_SIZE = sizeof(char[6]);

const char DATA5[][6] = {"Test1", "Test2", "Test3", "Test4", "Test5", "Test6", "Test7", "Test8", "Test9"}; 
const int DATA5_LEN = 9;
const int DATA5_CAP = 16;
const int DATA5_SIZE = sizeof(char[6]);

const char DATA6[][6] = {}; 
const int DATA6_LEN = 0;
const int DATA6_CAP = 0;
